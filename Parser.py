...
def p_filter_error(p):
    """filter : FILTER error"""
    print("\nSyntax error in filter statement. Bad expression")


def p_assignVariable_error(p):
    """assignVariable : VARIABLE IGUAL expr error"""
    print("\nSyntax error in assign statement. Bad expression")
